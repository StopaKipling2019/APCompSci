public class Main {
    ...
    public static String voteCounter(int[][] all, String[][] candidates, int office) {
        int[] votes = {0, 0, 0, 0, 0};
        for (int i = 0; i < votes.length; i++) {
            for (int j = 0; j < all[office].length; j++) {
                if (all[office + 1][j] == i) votes[i]++;
            } }

        String votesCounted = "The race for " + candidates[office][0] + ".\n";
